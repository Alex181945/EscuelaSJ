...
public class ImpPeriodoRest implements PeriodoRest {
	...
	public void insertaPeriodo(String cToken, Periodo objPeriodo) {
		...
		try {
			...
			MultiValueMap<String, String> body = new LinkedMultiValueMap<String, String>();     
			body.add("objPeriodo", mapper.writeValueAsString(objPeriodo));
			
			HttpEntity<?> httpEntity = new HttpEntity<Object>(body, headers);
			
			/*JSON obtenido de forma plana*/
			ResponseEntity<String> response = restTemplate.exchange(VariablesEntorno.getUrlwsd() + "/periodo/inserta",
	...
	public void actualizaPeriodo(String cToken, Periodo objPeriodo) {
		...
		try {
			...
			/*JSON obtenido de forma plana*/
			ResponseEntity<String> response = restTemplate.exchange(VariablesEntorno.getUrlwsd() + "/periodo/actualiza",
	...
	public Periodo[] consultaPeriodoSinCarrera(String cToken, Integer iTipoConsulta) {
		...
		try {
			...
			/*JSON obtenido de forma plana*/
			ResponseEntity<String> response = restTemplate.exchange(VariablesEntorno.getUrlwsd() + "/periodo/consulta-sin-carrera?iTipoConsulta=" + iTipoConsulta,
					HttpMethod.GET ,httpEntity, String.class);
